...
class ProfileDetail(APIView):
    ...
    Permission Class:
        IsOwnerOrReadOnly:
            This permission ensures that only the owner of the object can
            modify it (PUT, DELETE, etc.). Other users can still view the
            object (GET) but are restricted from making changes.
        Usage:
            - Owners of the profile (or resource) are allowed full access.
            - Non-owners are granted read-only access.
    """
